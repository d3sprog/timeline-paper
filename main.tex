...
\lstdefinelanguage{timeline}{
    morekeywords={IF, AND, STEP, COS, RADIANS, MAX, SIN, POWER, SUM, POINT, GRAPH, STROKECOLOR,
      ...
      ASPECTRATIO, INDEX, INDIRECT, OFFSET, RANDOM},
...
can be evaluated, and it can be checked with respect to $\Omega$, then it can also be evaluated
...
\end{theorem}
%\begin{proof}
%By induction over $n$. For $n=1$, $\gamma_1$ is $\sigma, \omega_0|\Omega \Downarrow \gamma_1$
%\end{proof}
