...
provides an overeview of the remaining main related research areas.
...
with time can draw on rich body of programming languages research. Our execution model takes
inspiration from synchronous dataflow languages and functional reactive programming, we
guarantee memory-bound execution using coeffects, the formula editor can leverage theory of
